...
import ActividadUpdateComponent from '@/entities/actividad/actividad-update.vue';
import ActividadClass from '@/entities/actividad/actividad-update.component';
...
describe('Component Tests', () => {
  describe('Actividad Management Update Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<ActividadClass>(ActividadUpdateComponent, {
        store,
        i18n,
        localVue,
        router,
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', async () => {
        ...
        actividadServiceStub.update.resolves(entity);
        ...
        // THEN
        expect(actividadServiceStub.update.calledWith(entity)).toBeTruthy();
      ...
      it('Should call create service on save for new entity', async () => {
        ...
        const entity = {};
        comp.actividad = entity;
        actividadServiceStub.create.resolves(entity);
        ...
        // THEN
        expect(actividadServiceStub.create.calledWith(entity)).toBeTruthy();
        expect(comp.isSaving).toEqual(false);
      });
    });
  });

        ...
        <b-collapse is-nav id="header-tabs">
            <b-navbar-nav class="ml-auto">
                ...
                <b-nav-item-dropdown
                    ...
                    <b-dropdown-item to="/entity/unknow-intents">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.unknowIntents')">UnknowIntents</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/entity/contacto">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.contacto')">Contacto</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/entity/evento">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.evento')">Evento</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/entity/actividad">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.actividad')">Actividad</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/entity/archivo">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.archivo')">Archivo</span>
                    </b-dropdown-item>

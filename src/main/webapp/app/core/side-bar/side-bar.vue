  ...
  <nav id="sidebar" :class="{active: collapse}">
    ...
    <div class="p-4">
      ...
      <ul   v-if="authenticated" class="list-unstyled components mb-5">
        <li >
          <a v-on:click="logout()" id="logouts">
            <span class="fa fa-sign-out mr-3"></span> {{ $t('global.menu.account.logout') }}
          </a>
        </li>  
      </ul>
      ...
      <ul v-if="!authenticated" class="list-unstyled components mb-5"> 
        <li >
          <a  v-on:click="openLogin()" id="login">
            <span class="fa fa-sign-in mr-3"></span> {{ $t('global.menu.account.login') }}
          </a>
        </li>  
      </ul>
    </div>
